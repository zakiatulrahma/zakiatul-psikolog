			...
			<div class="row justify-content-center">
				<div class="col-md-7 col-lg-5">
		            ...
		            <div class="form-group">
		            	<button type="submit" class="form-control btn btn-primary rounded-pill submit px-3">Masuk</button>
		            </div>
		            
				</form>
				<div class="form-group">
					<a href="{{ route('login.google') }}" class="form-control btn btn-secondary rounded-pill submit px-3">
