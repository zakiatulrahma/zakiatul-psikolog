				...
				<div class="col-md-7 col-lg-5">
                    ...
                    @endif
                          ...
                          <div class="form-group mt-4">
                            ...
                            <label class="form-control-placeholder" name="nama" for="nama">Nama Lengkap</label>
		            ...
		            <div class="form-group">
		            	<button type="submit" class="form-control btn btn-primary rounded-pill submit px-3">Daftar</button>
		            </div>
